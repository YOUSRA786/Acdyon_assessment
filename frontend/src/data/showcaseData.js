...
export const LEADERBOARD_USERS = [
  {
    ...
    streak: 12,
    country: 'DEMO',
    bio: 'Sample competitive profile demonstrating high-speed algorithmic traversal.',
    favLangs: ['Rust', 'C++', 'Python'],
    radarStats: { speed: 96, accuracy: 94, consistency: 91, concurrency: 89, complexity: 98 },
    recentMatches: [
      { id: 'm-101', opponent: 'Player 03', result: 'Victory (+24 ELO)', time: '04:12', problem: 'LRU Cache Design' },
      { id: 'm-102', opponent: 'Player 06', result: 'Victory (+18 ELO)', time: '03:45', problem: 'Trapping Rain Water' },
      { id: 'm-103', opponent: 'Player 02', result: 'Victory (+28 ELO)', time: '05:30', problem: 'Merge k Sorted Lists' }
    ]
  },
  {
    rank: 2,
    ...
    streak: 8,
    country: 'DEMO',
    bio: 'Sample competitive profile demonstrating graph traversal and DP optimization.',
    favLangs: ['C++', 'Go', 'Python'],
    radarStats: { speed: 92, accuracy: 96, consistency: 88, concurrency: 94, complexity: 95 },
    recentMatches: [
      { id: 'm-201', opponent: 'Player 01', result: 'Defeat (-12 ELO)', time: '05:30', problem: 'Merge k Sorted Lists' },
      { id: 'm-202', opponent: 'Player 03', result: 'Victory (+22 ELO)', time: '04:02', problem: 'Course Schedule II' }
    ]
  },
  {
    rank: 3,
    ...
    streak: 5,
    country: 'DEMO',
    bio: 'Sample competitive profile demonstrating systems concurrency and telemetry.',
    favLangs: ['Rust', 'TypeScript', 'Go'],
    radarStats: { speed: 89, accuracy: 91, consistency: 94, concurrency: 97, complexity: 90 },
    recentMatches: [
      { id: 'm-301', opponent: 'You (Sample)', result: 'Victory (+16 ELO)', time: '04:48', problem: 'Coin Change' }
    ]
  },
  {
    rank: 4,
    name: 'You (Sample Profile)',
    handle: '@you_demo',
    avatar: '👨‍💻',
    division: 'Diamond',
    elo: 2190,
    ...
    streak: 6,
    country: 'DEMO',
    bio: 'Sample user profile demonstrating live ladder climbing and match progression.',
    favLangs: ['TypeScript', 'Python', 'Rust'],
    radarStats: { speed: 88, accuracy: 92, consistency: 86, concurrency: 84, complexity: 89 },
    recentMatches: [
      { id: 'm-401', opponent: 'Player 05', result: 'Victory (+24 ELO)', time: '03:12', problem: 'Two Sum II' }
    ]
  },
  {
    rank: 5,
    ...
    streak: 3,
    country: 'DEMO',
    bio: 'Sample competitive profile demonstrating dynamic programming duels.',
    favLangs: ['Python', 'TypeScript', 'C++'],
    radarStats: { speed: 85, accuracy: 89, consistency: 88, concurrency: 82, complexity: 91 },
    recentMatches: [
      { id: 'm-501', opponent: 'Player 08', result: 'Victory (+19 ELO)', time: '04:15', problem: 'Valid Parentheses' }
    ]
  },
  {
    rank: 6,
    ...
    streak: 4,
    country: 'DEMO',
    bio: 'Sample competitive profile demonstrating memory layout optimization.',
    favLangs: ['C++', 'Rust', 'Go'],
  ...
  },
  {
    ...
    streak: 2,
    country: 'DEMO',
    bio: 'Sample competitive profile demonstrating algorithmic puzzle speed.',
  ...
  },
  {
    ...
    streak: 1,
    country: 'DEMO',
    bio: 'Sample competitive profile demonstrating two-pointer convergence.',
    favLangs: ['C++', 'Python'],
...
export const RECRUITER_CANDIDATE_DATA = {
  candidate: {
    name: 'Demo Candidate',
    role: 'Sample Senior Full-Stack Engineer',
    targetPosition: 'Demonstration Profile',
    experience: 'Sample Dossier',
    avatar: '👨‍💻',
    overallScore: 92.5,
    ratingGrade: 'S-Tier',
    metrics: [
    ...
    summary: 'Demonstration candidate profile illustrating algorithmic deduction, two-pointer convergence, and test case self-correction.',
    completedProblems: [
